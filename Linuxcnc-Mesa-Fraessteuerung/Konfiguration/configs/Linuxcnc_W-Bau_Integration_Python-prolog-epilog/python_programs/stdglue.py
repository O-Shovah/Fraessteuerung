...
# REMAP=M6  modalgroup=6 prolog=manual_toolchange_prolog ngc=change epilog=manual_toolchange_epilog
# exposed parameters:
#    #<tool_in_spindle>
#    #<selected_tool>
#    #<current_pocket>
...
def manual_toolchange_prolog(self, **words):
    try:
        ...
        if self.params[5600] > 0.0:
            if self.params[5601] < 0.0:
                ...
                return INTERP_ERROR
            print "manual_toolchange_prolog: Toolchanger soft fault %d" % int(self.params[5601])
        ...
        self.set_errormsg("M6/manual_toolchange_prolog: %s" % (e))
        return INTERP_ERROR

def manual_toolchange_epilog(self, **words):
    try:
        ...
        self.set_errormsg("M6/manual_toolchange_epilog: %s" % (e))
        return INTERP_ERROR
